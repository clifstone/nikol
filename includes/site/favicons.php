...
function favicons(){ ?>
    ...
    <link rel="icon" type="image/png" sizes="144x144" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/favicons/android-icon-144x144.png">
