...
$metaboxes = array(array('etsylink', 'ETSY LINK:', 'post'), array('appearancedate', 'Appearance Date (Ex: Tuesday, October 23rd):', 'appearancessection'), array('appearancelink', 'Appearance Live Link:', 'appearancessection'), array('appearancebgimg', 'Background Image:', 'appearancessection'));
