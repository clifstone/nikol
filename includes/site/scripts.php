...
function headerscripts(){
    ...
    echo '<link rel="preload" href="https://www.googletagmanager.com/gtag/js" as="script">';
...
function footerScripts(){
    ...
    if(get_option('gtag_code')){
        echo '
        <script async src="https://www.googletagmanager.com/gtag/js?id='.get_option('gtag_code').'"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag("js", new Date());

            gtag("config", "'.get_option('gtag_code').'");
        </script>
        ';
    }
}
